...
e = Event.create({
  ...
  starts_at: DateTime.parse('Fri, 11 May 2016 7:00 AM+0700'),
  ends_at: DateTime.parse('Sun, 13 May 2016 3:00 PM+0700'),
  venue: dalat,
...
e = Event.create({
  ...
  starts_at: DateTime.parse('Sat, 16 May 2016, 8:00 PM+0700'),
  ends_at: DateTime.parse('Sat, 16 May 2016, 10:30 PM+0700'),  
...
e = Event.create({
  ...
  starts_at: DateTime.parse('Thu, 24 May 2016, 8:00 PM+0700'),
  ends_at: DateTime.parse('Thu, 24 May 2016, 11:00 PM+0700'),
  venue: gap,
  category: Category.find_by(name: 'Entertainment'),
